...
export default function ReadERC20(props: Props) {
  ...
  return (
    <div>
      <div><b>ERC20 Contract</b>: {addressContract}</div>
      <div><b>ClassToken totalSupply</b>:{totalSupply} {symbol}</div>
      <div><b>ClassToken in current account</b>: {balance} {symbol}</div>
    </div>
  )
}
